...
module.exports = {
    ...
    entry: {
        ...
        circle: path.resolve(__dirname, '../src/mp/circle/main.mp.js'),
        news: path.resolve(__dirname, '../src/mp/news/main.mp.js'),
        mine: path.resolve(__dirname, '../src/mp/mine/main.mp.js'),
    },
    output: {
